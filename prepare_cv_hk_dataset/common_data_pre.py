...
def create_csv(
    save_cache_filename,orig_tsv_file, csv_file, data_folder, accented_letters=False, language="en",
):
    """
    ...
    for line in tzip(loaded_csv):
        ...
        words = pycantonese.segment(words)
        str1 = ' '
        ...
        # print("save_cache_filename",save_cache_filename)
        dst_folder = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/part/' + save_cache_filename 
        # print(filelist)
        # print("save_cache_filename",save_cache_filename + "/" + file_name) #+ "/" + file_name +".wav"
        saved_file_list = "/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/clips/" + snt_id + ".mp3"
        print(saved_file_list)
        shutil.copy(saved_file_list, dst_folder)  
...
data_folder = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK'
save_folder = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/part'
train_tsv_file = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/train.tsv'
dev_tsv_file = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/dev.tsv'
test_tsv_file = '/home/tower/project/dataset/cv-corpus-7.0-2021-07-21-zh-HK/cv-corpus-7.0-2021-07-21/zh-HK/test.tsv'
accented_letters = False
duration_threshold = 10
prepare_common_voice(
    data_folder,
